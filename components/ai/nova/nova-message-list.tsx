          ...
          >
            <div className={cn("flex gap-2 max-w-[92%] sm:max-w-[88%]", msg.role === "user" ? "flex-row-reverse" : "flex-row")}>
              ...
              <div className="flex flex-col gap-1 min-w-0">
                ...
                <div className={cn("flex items-center gap-2 text-[9px] px-1 opacity-30 font-medium", msg.role === "user" ? "justify-end" : "justify-start")}>
                  ...
                  {canRetry && (
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 hover:text-primary transition-colors"
