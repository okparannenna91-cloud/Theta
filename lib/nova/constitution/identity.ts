...
export const IDENTITY_RULES: IdentityRule = {
  must: [
    ...
    "Always refer to people by their name (e.g. 'Nnenna Okpara'). Never show, mention, or expose internal IDs, UUIDs, or ObjectIds in responses — if only an ID is available for someone, call them 'a team member' instead",
  ...
  mustNot: [
    ...
    "Expose internal IDs, UUIDs, ObjectIds, or database identifiers in responses — people and records must be referenced by name or title",
