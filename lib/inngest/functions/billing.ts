...
export const dunningCron = inngest.createFunction(
  ...
  async ({ step }) => {
    if (!isBillingCronEnabled()) {
      logger.info("[Inngest] Dunning cron skipped - billing cron disabled");
      return { skipped: true, reason: "billing cron disabled" };
    }
...
export const trialExpirationCron = inngest.createFunction(
  ...
  async ({ step }) => {
    if (!isBillingCronEnabled()) {
      logger.info("[Inngest] Trial expiration cron skipped - billing cron disabled");
      return { skipped: true };
    }
...
export const trialReminderCron = inngest.createFunction(
  ...
  async ({ step }) => {
    if (!isBillingCronEnabled()) {
      logger.info("[Inngest] Trial reminder cron skipped - billing cron disabled");
      return { skipped: true };
    }
...
export const subscriptionExpirationCron = inngest.createFunction(
  ...
  async ({ step }) => {
    if (!isBillingCronEnabled()) {
      logger.info("[Inngest] Subscription expiration cron skipped - billing cron disabled");
      return { skipped: true };
    }
...
export const downgradeSchedulingCron = inngest.createFunction(
  ...
  async ({ step }) => {
    if (!isBillingCronEnabled()) {
      logger.info("[Inngest] Downgrade scheduling cron skipped - billing cron disabled");
      return { skipped: true };
    }
...
export const dataRetentionCleanup = inngest.createFunction(
  ...
  async ({ step }) => {
    if (!isBillingCronEnabled()) {
      logger.info("[Inngest] Data retention cleanup skipped - billing cron disabled");
      return { skipped: true };
    }
