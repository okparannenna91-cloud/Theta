    ...
    const blocks: SlackBlock[] = [
      ...
      },
      {
        ...
        elements: [
          {
            type: "mrkdwn",
            text: `Sent from *Theta PM Platform* · <!date^${Math.floor(Date.now() / 1000)}^{date_short_pretty} at {time}|${new Date().toLocaleString()}>`,
          },
        ],
      },
    ];
  ...
  try {
    ...
    sections.push({
      ...
      elements: [
        {
          type: "mrkdwn",
          text: `Generated by *Theta PM* · ${tasks.length} total tasks`,
        },
      ],
    });
  ...
  try {
    ...
    blocks.push({
      ...
      elements: [
        {
          type: "button",
          text: { type: "plain_text", text: "View in Theta PM" },
  ...
  return [
    ...
    },
    {
      ...
      elements: [
        {
          type: "mrkdwn",
          text: `ID: \`${task.id}\` · <${appUrl}/tasks/${task.id}|Open in Theta PM>`,
        },
      ],
    },
  ];
