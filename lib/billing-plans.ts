...
export const BILLING_PLANS: BillingPlan[] = [
  {
    ...
    name: "Growth (Annual)",
    priceLabel: "$48",
    basePriceMonthlyUSD: 400, // 500*12*0.8/12 ≈ 400/mo equivalent
    perUserPriceMonthlyUSD: 160, // 200*12*0.8/12
    maxUsers: 15,
    currency: "USD",
    mode: "subscription",
    description: "For small growing teams — billed annually",
    paystackPlanCodes: {
  ...
  },
  {
    ...
    name: "Pro (Annual)",
    priceLabel: "$96",
    basePriceMonthlyUSD: 800, // 1000*12*0.8/12
    perUserPriceMonthlyUSD: 240, // 300*12*0.8/12
    maxUsers: 50,
    currency: "USD",
    mode: "subscription",
  ...
  {
    id: "theta-plus-annual",
    planKey: "theta_plus",
    name: "Theta Plus (Annual)",
    priceLabel: "$192",
    basePriceMonthlyUSD: 1600, // 2000*12*0.8/12
    perUserPriceMonthlyUSD: 320, // 400*12*0.8/12
    maxUsers: null,
    currency: "USD",
    mode: "subscription",
    description: "For enterprise-grade teams — billed annually",
    paystackPlanCodes: {
